...
#a test case
# timg = Image.new("RGB", (4, 6))
# timg.putpixel((0, 0), (255, 0, 0))
# timg.putpixel((1, 0), (255, 0, 0))
# timg.putpixel((2, 0), (255, 0, 0))
# timg.putpixel((3, 0), (255, 0, 0))
# timg.show()
# timg. save("tmp.png")
...
n_img = Image.new("RGB", (height-1, width-1))
for i in range(width):
